...
import image1 from '../../Images/cardimg1.jpg';
import image2 from '../../Images/cardimg2.jpg';
      ...
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-6">
        ...
        <div className="flex-1 bg-white rounded-lg shadow-lg p-4">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-2xl font-bold font-serif text-gray-800">Shopping Cart</h2>
          ...
          {cartItems.map((item) => (
            ...
            >
              ...
              <div className="flex items-center gap-4 mt-4 sm:mt-0 w-full sm:w-auto justify-between">
                <div className="flex items-center border-2 border-teal-500 rounded-full px-4 py-2 bg-gray-50">
                  <button
                    onClick={() => decreaseQuantity(item.id)}
                    className="w-8 h-8 pb-1  rounded-full flex items-center justify-center text-xl font-bold hover:bg-gray-300"
                  >
                    -
                  </button>
